...
Web Audio API (audio normalization, volume controls) does not work in Safari.\footnote{Even though \texttt{caniuseit} lists Safari as a compatible browser for Web Audio API\parencite{caniuse_webaudio}}\parencite{webkit_hls_webaudio,shaka_safari_webaudio}
