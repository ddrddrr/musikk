...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth, keepaspectratio]{diagrams/HighLevelSystem}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth, keepaspectratio]{diagrams/BackendSystem}
    \caption{Backend Architecture}
    \label{fig:backend}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth, keepaspectratio]{diagrams/FrontendSystem}
...
The per-app Backend class diagrams, the Frontend component hierarchy, and the behavioural sequence diagrams
can be found in the \texttt{specification/} directory, under
\texttt{specification/structure/backend/}, \texttt{specification/structure/frontend/component\_hierarchy.puml},
and \texttt{specification/behavior/} paths.
