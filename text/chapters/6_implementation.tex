...
%dependency is not necessary. In addition, the more popular and mature package \texttt{ffmpeg-python}\parencite{ffmpegpython}
%is not maintained anymore, and, e.g., OpenAI has dropped it as their dependency due to that reason\parencite{ffmpegopenai}.
%% ###
%
