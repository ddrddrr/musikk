...
``Must Have'' requirements specify functionality without which the application would not be finished.
...
\begin{itemize}
    ...
    \item \textbf{Feed} - A list of Publications accessible by any User.
...
\subsection*{Could Have}
\begin{itemize}
        % TODO  infinite scroll but more abstract wording
