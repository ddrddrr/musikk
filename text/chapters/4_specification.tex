...
The use case diagrams for each group are kept under
\path{text/diagrams/}, for example \path{text/diagrams/UseCasesAccount.png}.
...
\begin{itemize}
    ...
    \item The system shall support audio Playback over the network.
...
\begin{itemize}
    ...
    \item The system shall allow a User to switch the Active Playback Device between them.
\end{itemize}
...
\begin{itemize}
    ...
    \item
    The system shall make unauthorized access to data as difficult as possible, so that even
    with misconfigured access rights the data stays unreadable.
    \item
