...
The use case diagrams for each group are collected in the
\hyperref[app:diagrams]{Diagram Catalog} appendix~(Figures~\ref{fig:uc_account}
through~\ref{fig:uc_communication}).
