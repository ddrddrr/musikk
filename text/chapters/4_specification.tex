...
In this chapterm the general outline of the application is specified via functional and non-functional requirements.
...
\begin{itemize}
    ...
    \item The system shall provide a notification system. It shall show information about Users who followed the target User, new Reply Publication, etc.
...
\subsection*{Should Have}
\begin{itemize}
    \item The system shall provide a responsive search method that would react to dynamic User input.
