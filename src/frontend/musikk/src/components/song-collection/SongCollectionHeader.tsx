        ...
        <>
            ...
            <div className="flex items-center bg-white p-6 rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <img
                    ...
                    className={`transition-transform duration-300 object-cover border-2 border-black rounded-lg  ${
                        showComments ? "scale-75 w-32 h-32" : "scale-100 w-32 h-32"
                    }`}
                />
                ...
                <div className="flex gap-3">
                    <div
                        className={`bg-red-500 hover:bg-red-600 text-white border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-transform p-0 flex items-center justify-center ${
                    ...
                    <Button
                        ...
                        className={`bg-gray-200 hover:bg-gray-300 text-black border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-transform p-0 flex items-center justify-center ${
                            showComments ? "h-8 w-8" : "h-12 w-12"
                        }`}
                    >
            ...
            <div className="flex items-center justify-between px-2">
                <h3 className="text-black text-lg font-bold">Songs • {songsCount}</h3>
                <Button
                    onClick={toggleComments}
                    className={`bg-blue-500 hover:bg-blue-600 text-white border-2 border-black rounded-lg 
                    ${showComments ? "h-8 px-3" : "h-12 px-4"} 
